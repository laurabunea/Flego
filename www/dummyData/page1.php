...
//breadcrumbs is just dummy breadcrumbs from flego 
$vars['aboutUsSection'] = array(
    array(
        "type" => "h2",
        "data" => "About us"
    ),
